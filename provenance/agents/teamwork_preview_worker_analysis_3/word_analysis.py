...
def get_sentences(text):
    # Split text into lines/paragraphs first to preserve structural boundaries
    # as sentence separators so they are not merged.
    lines = text.split('\n')
    ...
    for line in lines:
        ...
        for abbr in abbreviations:
            ...
            cleaned = re.sub(rf'\b{re.escape(abbr)}', placeholder, cleaned, flags=re.IGNORECASE)
