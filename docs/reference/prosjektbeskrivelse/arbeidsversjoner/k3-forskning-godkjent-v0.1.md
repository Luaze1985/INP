...
formaal: Stabil referanse med faste avsnitts-, setnings- og FoU-ID-er
---

# K3 — Mål og FoU-spørsmål

> Denne filen er en godkjent arbeidsversjon. Den erstatter ikke det kanoniske kapitlet før endringen er flettet inn og loggført. Bruk ID-ene under når tekst skal kommenteres, siteres eller revideres, for eksempel `K3-P2-S2` eller `K3-F5`.
...
- `F1–F6` = prosjektets seks FoU-spørsmål
...
<a id="k3-p2-s1"></a>**[K3-P2-S1]** Prosjektets FoU-bidrag ligger ikke i å lage en enkel poengformel alene.

<a id="k3-p2-s2"></a>**[K3-P2-S2]** Det ligger i å undersøke hvordan vekting, datakvalitet og usikkerhet kan dokumenteres og forklares, og hvordan modellen fungerer i reelle løsningsvalg.

<a id="k3-p2-s3"></a>**[K3-P2-S3]** VERIFIED skal teste om entreprenører og kunder forstår grunnlaget, hvordan de bruker det, og om det endrer eller bekrefter valget.

### K3-P3 — FoU-spørsmål

<a id="k3-p3-s1"></a>**[K3-P3-S1]** Prosjektet samles i seks FoU-spørsmål:

| ID | Tema | FoU-spørsmål |
| --- | --- | --- |
| <a id="k3-f1"></a>**[K3-F1]** | Kvalitet og levetid mot økonomi | Hvordan kan dokumentasjon av levetid, vedlikehold og kvalitet omsettes til sammenlignbare livsløpskostnader og inngå i avveiingen mellom økonomi, klima og teknisk kvalitet? |
| <a id="k3-f2"></a>**[K3-F2]** | Data tidlig nok i tilbud | Kan NOBB, GTIN, EPD, FDV og prisdata kobles slik at de kan brukes før tilbudet sendes? |
...
<a id="k3-p4-s1"></a>**[K3-P4-S1]** Arbeid før innsending er avgrenset til konsept, problemanalyse, kildesjekk og søknadsarbeid.
