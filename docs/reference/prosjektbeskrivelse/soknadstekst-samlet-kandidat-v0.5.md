...
Prosjektet skal undersøke hvordan pris, klima, levetid, vedlikehold, teknisk kvalitet, ombruk, dokumentasjon og risiko kan settes sammen til et forklarbart og etterprøvbart beslutningsgrunnlag. Grunnlaget skal vise forskjeller, avveininger og usikkerhet uten at verktøyet tar beslutningen for brukeren.

VERIFIED skal utvikles og testes gjennom konkrete løsningsvalg. Prosjektet skal måle om entreprenør og kunde forstår grunnlaget, hvordan de bruker det, om det endrer eller bekrefter valget, og om nytten forsvarer tidsbruken. VIBS-plattformen kan brukes som testflate, men forsknings- og utviklingsarbeidet (FoU) ligger i VERIFIED-laget: metode, datakvalitet, vekting, usikkerhet og målt beslutningseffekt.
...
En snekker eller mindre entreprenør kan være svært god på faget sitt, samtidig som bedriften ikke har egne ressurser for livsløpsvurderinger (LCA), kostnadsanalyser over levetiden og andre spesialiserte vurderinger.
...
### Hva VERIFIED skal gjøre

VERIFIED skal utvikle og teste en beslutningsmodell som samler, vekter og forklarer informasjon om alternative løsninger i tilbudsfasen. Målet er at entreprenør og kunde skal kunne se forskjeller, fordeler, ulemper og usikkerhet ved alternativene, uten at verktøyet tar beslutningen for dem.

Prosjektet skal ikke bevise at en ferdig løsning allerede virker. Det skal undersøke hvordan et slikt beslutningsgrunnlag kan bygges, forklares og måles i reelle løsningsvalg.

## K2 — Nyhetsverdi

### Hva nyhetsverdien er

VERIFIED er ikke først og fremst en ny app, miljømerking eller kalkulator. Nyhetsverdien ligger i å utvikle og teste hvordan flere typer byggdata kan settes sammen til et forklarbart og etterprøvbart beslutningsgrunnlag i tilbudsfasen.
...
Tilgjengelighet, kvalitet og format varierer mellom datakildene. De kartlagte standardene, datakildene, metodene og verktøyene dekker ulike deler av behovet. De er i hovedsak rettet mot analyse, prosjektering, dokumentasjon eller enkeltkriterier, og er ikke dokumentert som ett samlet beslutningsgrunnlag for tilbudsfasen.
...
### Skillet mellom plattform og FoU-lag

Det nye FoU-laget er ikke selve VIBS-plattformen. VIBS-plattformen kan brukes som testflate for prosjektet. VERIFIED-laget er forskningsarbeidet: hvordan vekting, datakvalitet, usikkerhet og beslutningseffekt kan dokumenteres på en måte som tåler kontroll.
...
| --- | --- |
| Kan flere datatyper kobles? | Eksisterende løsninger dekker ulike datatyper, men kartleggingen dokumenterer ikke én løsning som samler hele bredden. |
| Brukes det i tilbudsfasen? | Bruk i tilbudsfasen er svakt dokumentert. |
| Kan små entreprenører bruke det? | Ressursbehov og anvendbarhet for små entreprenører er ikke tilstrekkelig dokumentert. |
| Vises usikkerheten? | Det er ikke dokumentert hvordan datakvalitet og usikkerhet kan synliggjøres gjennom hele sammenligningen. |
| Måles beslutningseffekt? | Kartleggingen fant ikke en dokumentert metode for å måle og tilskrive om grunnlaget endret eller bekreftet valget. |
| Håndteres do-not-harm? | Det er ikke dokumentert én modell som kombinerer klima med levetid, vedlikehold, ombruk og risiko. |

VERIFIED skal ikke påstå at alle disse punktene er løst. Prosjektet skal teste dem. Dersom prosjektet lykkes, vil modellen kunne vise forskjeller, avveininger og usikkerhet mellom alternative løsninger. Entreprenør og kunde skal fortsatt ta beslutningen.
...
### Avgrensning før tildeling

Arbeid før innsending er avgrenset til konsept, problemanalyse, kildesjekk og søknadsarbeid. Selve FoU-aktivitetene starter etter innsending og eventuell tildeling.

VIBS-plattformen kan brukes som testflate for prosjektet, men forskningsarbeidet er VERIFIED-laget: metode, datakvalitet, vekting, usikkerhet og målt beslutningseffekt.

## K4 — Metode og forskningsetikk

### Forskningsløype

Prosjektet skal bruke en iterativ forskningsmodell. Først utvikles en første versjon av beslutningsmodellen. Den testes deretter i konkrete løsningsvalg, resultatene måles, og modellen justeres på grunnlag av funnene.
...
| Forklarbarhet | Om brukeren forstår hvorfor alternativene får ulike resultater |
| Usikkerhet | Om brukeren oppdager manglende, generelle eller estimerte data |
...
Forskningsetikk og datahåndtering er en integrert del av metoden. Prosjektet kan behandle brukerdata, kommersielt sensitive opplysninger og informasjon om beslutninger i pilotene.

Deltakerne skal få tydelig informasjon om formål, databruk, lagringstid og retten til å trekke seg. Det skal samles inn minst mulig persondata, og forskningsdata skal anonymiseres eller pseudonymiseres før analyse.

VERIFIED skal være beslutningsstøtte, ikke en automatisk beslutningstaker. Modellen skal ikke profilere personer eller ta kredittbeslutninger. Endelig faglig og kommersiell vurdering ligger hos aktørene som bruker grunnlaget. Prosjektet skal være åpent om datakilder, antakelser, svakheter og usikkerhet.

Forskningssikkerhet og datahåndteringsplan konkretiseres ved eventuell tildeling, mens søknaden skal beskrive prinsippene, risikoene og ansvarsdelingen.

## V1 — Miljø og bærekraft

### Hovedbidrag

Prosjektets viktigste bærekraftsbidrag er bedre bruk av ressurser i bygg. Det treffer særlig FNs bærekraftsmål 12.2 om effektiv bruk av naturressurser. Det kan også treffe 12.5 dersom pilotene måler ombruk, reparasjon, utsatt utskifting og redusert materialbruk eller avfall.

### Mekanismen

VERIFIED skal ikke telle flest mulig bærekraftsmål. Et bedre beslutningsgrunnlag i tilbudsfasen kan gjøre det mulig å sammenligne alternative løsninger, blant annet nyanskaffelse, vedlikehold, reparasjon, rehabilitering og ombruk. Prosjektet skal måle hvordan grunnlaget påvirker valgene, ikke forutsette at én løsning alltid er best.

### Mulighetsrom for klima

Norske kilder peker på at tidlige materialvalg kan gi et betydelig mulighetsrom for å redusere klimagassutslipp uten å øke prosjektkostnaden. Dette brukes som et mulighetsrom, ikke som et løfte om effekt fra VERIFIED. Prosjektet skal teste om en forklarbar modell faktisk gjør slike avveininger lettere i praksis.
...
Utlysningen har en egen prioritering for sirkulærøkonomi: løsninger for økt ombruk, reparasjon eller deling av knappe ressurser. VERIFIED kan treffe denne prioriteringen dersom ombruk, vedlikehold, restlevetid og redusert materialbruk blir reelle alternativer og målepunkter i pilotene.
...
Prosjektet skal bidra til bedre ressursbruk, men det må ikke løse ett problem ved å skape et annet. Derfor skal do-not-harm være en del av beslutningsmodellen og piloteringen, ikke bare et kontrollpunkt i et vedlegg.

Modellen skal ikke automatisk utpeke ett alternativ som best. Den skal vise avveininger, usikkerhet og mulige negative konsekvenser ved hvert alternativ.

Lavt klimagassutslipp skal ikke skjule kort levetid, svak dokumentasjon eller høy teknisk risiko. Lav pris skal heller ikke skjule høyt vedlikeholdsbehov, hyppige utskiftninger eller større risiko for avvik.
...
| --- | --- | --- |
| Lavt klimagassutslipp, men svak levetid eller teknisk risiko | Levetid, vedlikehold og teknisk risiko vises separat, med tydelig advarsel og synlig avveining | Test om brukeren oppdager konflikten mellom kriteriene |
| Lav pris, men økt materialbruk eller utskifting | Nyanskaffelse sammenlignes med reparasjon, vedlikehold, rehabilitering og ombruk der det er relevant | Sammenlign livsløpskostnad og beregnet ressursbruk |
...
| Generelle eller estimerte data framstår som sikre | Datastatus og usikkerhet vises for hvert relevant datapunkt | Test om brukeren oppdager usikkerheten |
...
Det skal også testes hvor følsomt resultatet er for endrede vekter, manglende data og alternative forutsetninger. Dersom små endringer gir en annen rangering, skal dette vises for brukeren.

### Kjemikalier og sosiale forhold

Prosjektet skal kartlegge hvilke kjemikalie-, helse- og sikkerhetsopplysninger som finnes i EPD, FDV og annen produktdokumentasjon, og tydelig vise når nødvendig informasjon mangler eller ligger utenfor modellen.
...
VERIFIED skal være beslutningsstøtte, ikke en automatisk beslutningstaker. Modellen skal ikke profilere personer eller ta kredittbeslutninger. Endelig faglig og kommersiell vurdering ligger hos aktørene som bruker grunnlaget.

## V3 — Økonomiske virkninger og bankrelevans

### Hovedavgrensning

VERIFIED skal først og fremst løse et byggproblem. Banksporet er en mulig anvendelse av bedre byggdata, ikke et eget hovedspor.
...
Det finnes forskning som kobler energieffektivitet til lavere misligholdsrisiko i boliglån. Det finnes også europeiske bankrammer som etterspør bedre dokumentasjon om miljøforhold, men disse er i stor grad energisentrerte.

Den gjennomførte kunnskapskartleggingen har ikke identifisert tilsvarende dokumentasjon for sammenhengen mellom byggteknisk kvalitet, levetid, vedlikeholdsbehov og bankens risikovurdering. Dette behandles derfor som et FoU-spørsmål, ikke som en etablert sammenheng.
...
Referansene skal innarbeides i et eget kildepass. Kildepasset skal kontrollere hver bærende påstand mot originalkilde og autoritativ kildedom uten å gjenåpne den godkjente prosjektretningen.
