...
**Alt-strategi:** Bakgrunnsbildene er dekorative CSS-bakgrunner og skal ikke ha alt-tekst. Hvis de senere legges inn som `<img>`, bruk korte, nøytrale beskrivelser av motivet — ikke påstander om prosjektet.

## Flyt og budskap

1. Hold heroen rolig. Den åpner et forskningspremiss, den selger ikke et ferdig produkt.
2. La Utfordringen bære bransjebildet samlet, med SSB-tallene som lett tekstur og forbeholdet synlig.
3. Gjør «Hva vi ikke vet» til vendepunktet. Det er der prosjektet blir forskning og ikke produktutvikling.
4. La metoden komme etter gapet. Da leses den som svar på noe dokumentert.
...
Hele manuset er skrevet om fra v0.9. Følgende er **tatt ut** av den offentlige teksten:

- **«~32 %» lavere misligholdsrisiko** (Kaza 2014 / Billio 2022). v0.9 oppgir ingen prosentsats og sier
  eksplisitt at prosjektet ikke gjør det før originalanalysen er kontrollert. Sammenhengen omtales
  fortsatt, uten tall, med forbehold om at studien gjelder energieffektivitet i Nederland.
- **De fire faktakortene** i utfordringsseksjonen — vannskadeerstatning, byggekostnad mot Sverige,
  driftsmargin og konkurstall. Ingen av dem finnes i v0.9. Erstattet av SSB tabell 10309, som er
  offisiell statistikk med kjent forbehold. Kildene og begrunnelsen for hver enkelt er ført i
  endringslogg 0.6 i `docs/reference/ipn-kildebibliotek.md`.
- **«Forskning indikerer at minst halvparten av alle boliger har minst én byggefeil… 10-30 mrd»**
  (Gullbrekken & Holme 2025). Ute av v0.9.
- **Hele konsortiumslisten** — VIBS, SINTEF, Ordercontrol/Byggstand, Tirna Fagskole, NorDan,
  Flekkefjord Sparebank, Farsund kommune, Miljødirektoratet. v0.9 nevner ingen partnere.
- **Alle personnavn**, inkludert «Thomas Thorsen», som aldri lot seg bekrefte mot noe kildedokument
  (flagget ⚪ i faktasjekken 2026-06-29 og likevel stående live til nå).
- **BKA2-boksen** (11,7 MNOK til 2028, Vegard Knotten). Finnes ikke i v0.9.
- **«SINTEF leder det faglige arbeidet»** og **«kvalitetssikret av SINTEF»**. Erstattet av
  «forskningspartneren», som er v0.9s egen formulering.
- **«Sammen med Flekkefjord Sparebank skal vi undersøke…»** → «en avgrenset pilot skal undersøke»,
  uten banknavn, og med v0.9s forbehold om at prosjektet ikke forutsetter noen effekt.
- **Bunnbildet fra Listers kapitaldag** med fire navngitte personer, og samme bilde som OG-bilde.

**Ny seksjon 6.** «Hvorfor vi er de rette» var utelukkende konsortium og navn. Erstattet av
«Slik jobber vi», bygget på v0.9 K4 — dokumentasjonsstatus, minste informasjonsgrunnlag, teknisk
egnethet som faglig port, og skillet måler/beregner/estimerer/faglig vurderer.

**Ikke endret:** heroens tittel «Her er hva vi vet. Her er hva vi skal finne ut.» Den bærer fortsatt,
og er nå mer dekkende enn før.
